            ...
            <div class="col-xs-12 col-sm-12">
              <div class="categories-container">
                <ul class="categories-list" id="categories-list">
                  <li><a class="categories-item" href="/pages/informationen/about_us.php">Über uns</a></li>
                  <li><a class="categories-item categories-item-selected" href="/pages/informationen/agb.php">AGB</a></li>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <p class="text-body-1 text-weight-regular">(1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop http://www.portapc.de.
                ...
                <br><br>
                (5) Speicherung des Vertragstextes bei Bestellungen über unseren Internetshop : Wir senden Ihnen die Bestelldaten und unsere AGB per E-Mail zu. Die AGB können Sie jederzeit auch unter http://www.portapc.de/pages/informationen/agb
