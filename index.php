  ...
  <div class="navbar-fixed nav-default" id="nav-container">
    <nav class="nav-default" id="nav">
      <div class="nav-wrapper">
        <div class="website-logo" onclick="visitURL('homepage', true)"></div>
      </div>
    </nav>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-12 col-lg-10">
        ...
        <div class="row search-container">
          ...
          <div class="col-sm-8 col-md-9 col-lg-9 fill-height margin-a-0">
            <div class="input-field margin-a-0 fill-height">
              ...
              <div class="row margin-a-0 padding-a-0 fill-height">
                <div class="col-sm-2 col-md-1 margin-a-0 padding-a-0 align-self-center text-align-center">
                  <i class="search-icon material-icons">search</i>
                </div>

                <div class="col-sm-10 col-md-11 margin-a-0 padding-a-0">
                  <input class="search-input margin-y-0" placeholder="Wonach suchen Sie?" type="text" onkeydown="handleSearch(this)">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-3 col-lg-3 margin-a-0 fill-height searchbar-category-container vertical-left-line categories-dropdown-container">
        ...
        <div class="col-sm-12 col-md-8 col-lg-9 margin-a-0 padding-a-0">
          <div class="row">
            ...
            <?php if ($products_latest_json->has_more === true){
              ...
              <div class="col-sm-6">
                <a class="category-show-more text-uppercase clickable float-right" href="pages/products/category.php?sortBy=created_at&sortOrder=desc">alles anzeigen</a>
              </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-xs-12 col-m-2 col-lg-2">
          ...
          <a href="/pages/informationen/about_us.html">
            <p class="footer-content">Über uns</p>
          </a>
          <a href="/pages/informationen/impressum.html">
            <p class="footer-content">Impressum</p>
          </a>
          <a href="/pages/informationen/agb.html">
